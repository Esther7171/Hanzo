...
echo ""
echo ""
    echo -e "\e[1;35m[1]\e[0m \e[1;35m SCAN SAFTLY All Basic Network\e[0m" #purple
    echo ""
    echo -e "\e[1;35m[2]\e[0m \e[1;35m All 5g Networks \e[0m"
    echo ""
    read -p "Select an Options => " uoioill
    if [ $uoioill == 1 ]
    then
    echo ""
    clear
    ...
    echo ""
    iwconfig
    read -p "Enter Interface Name => " kxtmj
